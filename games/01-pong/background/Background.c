...
{
    BYTE has_x_intersection = area1.x[0] >= area2.x[0] && area1.x[0] <= area2.x[1] || area1.x[1] >= area2.x[0] && area1.x[1] <= area2.x[1];
    BYTE has_y_intersection = area1.y[0] >= area2.y[0] && area1.y[0] <= area2.y[1] || area1.y[1] >= area2.y[0] && area1.y[1] <= area2.y[1];
